/**
 * Country data for phone number inputs.
 * Source: REST Countries API (https://restcountries.com/v3.1)
 * Generated once — do not edit manually.
 */
...
export interface CountryOption {
  ...
  /** International dial code with + prefix, e.g. "+91" */
  readonly dialCode: string;
}

/**
 * Derives a flag emoji from an ISO 3166-1 alpha-2 country code.
 * Uses Unicode Regional Indicator Symbols (works on all modern platforms).
 */
...
export const COUNTRIES: readonly CountryOption[] = [
  ...
  { name: "Saint Helena, Ascension and Tristan da Cunha", code: "SH", dialCode: "+2" },
  ...
  { name: "Svalbard and Jan Mayen", code: "SJ", dialCode: "+4779" },
  ...
  { name: "United States Minor Outlying Islands", code: "UM", dialCode: "+268" },
  ...
  { name: "Vatican City", code: "VA", dialCode: "+3" },
  { name: "Venezuela", code: "VE", dialCode: "+58" },
  { name: "Vietnam", code: "VN", dialCode: "+84" },
  { name: "Wallis and Futuna", code: "WF", dialCode: "+681" },
  { name: "Western Sahara", code: "EH", dialCode: "+2" },
