            ...
            <main>
                ...
                >
                    <PricingSection
                        ...
                        description={"Shared credit wallet pricing and 12-month credit validity."}
                        sectionClassName="py-14 sm:py-20 bg-linear-to-b from-background via-card/30 to-background border-y border-border/60"
                        footerNote="GST shown at 18% for India. Outside India, local taxes may differ."
                        onPlanSelect={() => navigate(isAuthenticated ? '/billing' : '/register')}
                    />
                </motion.div>
