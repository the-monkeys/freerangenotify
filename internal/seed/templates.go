...
var LibraryTemplates = []template.Template{
  ...
  <a href="{{.cta_url}}" style="display: inline-block; padding: 12px 24px; background: #4F46E5; color: white; text-decoration: none; border-radius: 6px;">Get Started</a>
		...
		Locale:    "en",
		Status:    "active",
		Metadata:  map[string]interface{}{"category": "transactional"},
	},
	{
		Name:        "password_reset",
  ...
  <p>Estimated delivery: {{.delivery_date}}</p>
	...
	},
	{
		...
		Locale:      "en",
		Status:      "active",
		Metadata:    map[string]interface{}{"category": "notification"},
	},
	{
  ...
  <tr><td style="background-color:#161616;padding:24px 32px;border-radius:0 0 12px 12px;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr><td align="center">
		...
		Locale:   "en",
		Status:   "active",
		Metadata: map[string]interface{}{"category": "newsletter"},
	},
	{
	...
	// ── Phase 4: Newsletter Template Library Expansion ──
	{
		...
		Metadata: map[string]interface{}{
			...
			"sample_data": map[string]interface{}{
				...
				"logo_url":            "https://via.placeholder.com/140x40/4f46e5/ffffff?text=Logo",
				"tagline":             "Innovation delivered.",
				"hero_image_url":      "https://via.placeholder.com/640x300/4f46e5/ffffff?text=Product+Hero",
	...
	},
	{
		...
		Metadata: map[string]interface{}{
			...
			"sample_data": map[string]interface{}{
				...
				"speaker1_image":     "https://via.placeholder.com/80x80/4f46e5/ffffff?text=S1",
				"speaker1_name":      "Priya Sharma",
				"speaker1_title":     "Principal Engineer, Notifications @ Scale",
				"speaker2_image":     "https://via.placeholder.com/80x80/7c3aed/ffffff?text=S2",
	...
	},
	{
		...
		Metadata: map[string]interface{}{
			...
			"sample_data": map[string]interface{}{
				...
				"logo_url":         "https://via.placeholder.com/140x40/2563eb/ffffff?text=Logo",
				"issue_number":     "42",
				...
				"featured_image":   "https://via.placeholder.com/576x280/2563eb/ffffff?text=Featured",
				...
				"article1_image":   "https://via.placeholder.com/100x72/e2e8f0/64748b?text=A1",
				...
				"article2_image":   "https://via.placeholder.com/100x72/e2e8f0/64748b?text=A2",
				...
				"article3_image":   "https://via.placeholder.com/100x72/e2e8f0/64748b?text=A3",
				...
				"article4_image":   "https://via.placeholder.com/100x72/e2e8f0/64748b?text=A4",
				...
				"article5_image":   "https://via.placeholder.com/100x72/e2e8f0/64748b?text=A5",
	...
	},
	{
		...
		Metadata: map[string]interface{}{
			...
			"sample_data": map[string]interface{}{
				...
				"member_avatar":          "https://via.placeholder.com/120x120/f59e0b/1c1917?text=DS",
				"member_name":            "Dave S.",
