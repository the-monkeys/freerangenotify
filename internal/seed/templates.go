...
//go:embed newsletter_company_update.html
var newsletterCompanyUpdateHTML string

//go:embed event_local_meetup.html
var localMeetupHTML string

//go:embed frn_platform_updates.html
var frnPlatformUpdatesHTML string

//go:embed promo_healthy_food.html
var promoHealthyFoodHTML string
...
var LibraryTemplates = []template.Template{
	{
		Name:        "frn_platform_updates",
		Description: "Platform updates newsletter with Coral/Orange theme, interactive features, and quick tips",
		Channel:     "email",
		Subject:     "{{.headline_1}} {{.headline_2}}",
		Body:        frnPlatformUpdatesHTML,
		Variables: []string{
			"title", "header_logo_url", "brand_name", "product_name", "header_badge",
			"headline_1", "headline_2", "intro_text",
			"features_heading", "features_subheading",
			"feature1_title", "feature1_desc", "feature1_image_url",
			"feature2_title", "feature2_desc", "feature2_image_url",
			"tips_heading",
			"tip1_icon_url", "tip1_title", "tip1_desc",
			"tip2_icon_url", "tip2_title", "tip2_desc",
			"tip3_icon_url", "tip3_title", "tip3_desc",
			"footer_heading", "footer_subheading",
			"contact_email", "contact_mobile",
			"footer_credit_1", "footer_credit_2",
		},
		Locale: "en",
		Status: "active",
		Metadata: map[string]interface{}{
			...
			"sample_data": map[string]interface{}{
				"title":               "FreeRange Notify Update",
				"header_logo_url":     "",
				"brand_name":          "FreeRange",
				"product_name":        "Notify",
				"header_badge":        "Latest Issue",
				"headline_1":          "Platform Update",
				"headline_2":          "Newsletter",
				"intro_text":          "In this issue, we're sharing expert tips, new trends, and exciting updates to help you elevate your multi-channel communication campaigns without provider lock-in.",
				"features_heading":    "New Tools and Features",
				"features_subheading": "We've added new features to make your notification workflows even more powerful:",
				"feature1_title":      "Interactive WhatsApp",
				"feature1_desc":       "Target specific user groups with highly personalized rich media and button templates.",
				"feature1_image_url":  "",
				"feature2_title":      "Live Activity Feed",
				"feature2_desc":       "Our new and improved dashboard provides real-time metrics and deeper observability.",
				"feature2_image_url":  "",
				"tips_heading":        "Quick Tips to Improve Engagement",
				"tip1_icon_url":       "",
				"tip1_title":          "Optimize Channels",
				"tip1_desc":           "Ensure your messages are tailored for SMS, Email, and WhatsApp independently.",
				"tip2_icon_url":       "",
				"tip2_title":          "Test and Refine",
				"tip2_desc":           "Always A/B test templates, content, and send times to find what resonates best.",
				"tip3_icon_url":       "",
				"tip3_title":          "Segment Effectively",
				"tip3_desc":           "Break down your list into smaller, targeted groups for more personalized communication.",
				"footer_heading":      "Ready to scale your notifications?",
				"footer_subheading":   "Thank you for trusting FreeRange Notify to power your production systems.",
				"contact_email":       "monkeys.admin@monkeys.com.co",
				"contact_mobile":      "+919611808267",
				"footer_credit_1":     "FreeRange Notify by Buddhicintaka",
				"footer_credit_2":     "Ship Notifications Without Provider Lock-in",
			},
		},
	},
	{
...
<table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px;width:100%;">
  ...
  <tr><td style="background-color:#161616;padding:24px 32px;border-radius:0 0 12px 12px;">
	...
	},
	{
		...
		Channel:     "email",
		Subject:     "{{.product_name}} {{.version}} — {{.header_subtitle}}",
		Body:        newsletterChangelogHTML,
		Variables: []string{
			"preheader_text", "product_name", "header_subtitle", "version", "release_date", "release_summary",
			"added_heading", "added_1", "added_2", "added_3",
			"fixed_heading", "fixed_1", "fixed_2", "fixed_3",
			"breaking_heading", "breaking_1", "breaking_2",
			"upgrade_guide_text", "upgrade_guide_url", "cta_text",
			"footer_text",
		},
		Locale: "en",
		Status: "active",
		Metadata: map[string]interface{}{
			...
			"sample_data": map[string]interface{}{
				...
				"upgrade_guide_text": "Read the full upgrade guide for migration steps and examples.",
				"upgrade_guide_url":  "https://github.com/the-monkeys/FreeRangeNotify/blob/main/UPGRADE.md",
				"cta_text":           "View Upgrade Guide",
				"footer_text":        "\u00A92026 This email is sent to you by https://freerangenotify.com",
			},
		},
	},
	{
	...
	{
		Name:        "newsletter_company_update",
		Description: "Professional 3-section company update newsletter with switchable image/SVG illustrations.",
		Channel:     "email",
		Subject:     "{{.title}}",
		Body:        newsletterCompanyUpdateHTML,
		Variables: []string{
			"title", "subtitle", "company_name",
			"header_logo_url",
			"section1_heading", "section1_subheading", "section1_body", "section1_image_url",
			"section2_heading", "section2_subheading", "section2_body", "section2_image_url",
			"section3_heading", "section3_subheading", "section3_body", "section3_image_url",
			"footer_text",
		},
		Locale: "en",
		Status: "active",
		Metadata: map[string]interface{}{
			...
			"sample_data": map[string]interface{}{
				...
				"subtitle":            "ISSUE NO. 1: April 2026",
				"company_name":        "BUDDHICINTAKA PVT LTD",
				"header_logo_url":     "",
				"section1_heading":    "Thoughts from the CEO",
				"section1_subheading": "Dave Augustus",
				"section1_body":       "The world is changing rapidly. We're excited to share our vision for the year ahead and the innovations we're bringing to market.",
				"section1_image_url":  "",
				"section2_heading":    "Product Launch Update",
				"section2_subheading": "What ships this month",
				"section2_body":       "Our newest tool takes design to a completely new level. After extensive testing, our latest features are fully functional and ready for you.",
				"section2_image_url":  "",
				"section3_heading":    "Growth & Community",
				"section3_subheading": "Milestones worth celebrating",
				"section3_body":       "We've seen another quarter of sizable growth. It's all thanks to our loyal community — we couldn't be happier.",
				"section3_image_url":  "",
				"footer_text":         "©2026 This email is sent to you by https://freerangenotify.com.",
			},
		},
	...
	{
		Name:        "promo_healthy_food",
		Description: "Promotional food menu template featuring a fresh, curved design with staggered circular items.",
		Channel:     "email",
		Subject:     "{{.main_heading_1}} {{.main_heading_2}}",
		Body:        promoHealthyFoodHTML,
		Variables: []string{
			"title", "top_left_decoration_url", "top_right_decoration_url",
			"main_heading_1", "main_heading_2", "subheading",
			"item1_image_url", "item1_label",
			"item2_image_url", "item2_label",
			"item3_image_url", "item3_label",
			"item4_image_url", "item4_label",
			"footer_text_1", "footer_text_2",
			"contact_text", "contact_email", "contact_mobile",
		},
		Locale: "en",
		Status: "active",
		Metadata: map[string]interface{}{
			"category": "promo",
			"sample_data": map[string]interface{}{
				"title":                    "Fresh & Healthy Menu Promo",
				"top_left_decoration_url":  "",
				"top_right_decoration_url": "",
				"main_heading_1":           "FRESH & HEALTHY",
				"main_heading_2":           "FOOD PROMO!",
				"subheading":               "Try our new healthy menu:",
				"item1_image_url":          "",
				"item1_label":              "PROTEIN LADOO",
				"item2_image_url":          "",
				"item2_label":              "FRESH SALADS",
				"item3_image_url":          "",
				"item3_label":              "VEG CURRIES",
				"item4_image_url":          "",
				"item4_label":              "HEALTHY DRINKS",
				"footer_text_1":            "Enjoy nutritious and delicious meals made fresh daily.",
				"footer_text_2":            "Order now and get 20% off your first meal.",
				"contact_text":             "Reach us out for more questions or orders:",
				"contact_email":            "monkeys.admin@monkeys.com.co",
				"contact_mobile":           "+919611808267",
			},
		},
